  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '预算目标管理', icon: 'PieChart' }
      },
      {
        path: 'ai-config',
        name: 'AiConfig',
        component: () => import('@/views/ai/AiConfigView.vue'),
        meta: { title: 'AI系统配置', icon: 'Cpu' }
      },
      {
        path: 'logs',
        name: 'OperationLog',
      ...
      },
      {
        path: 'admins',
        name: 'AdminAccount',
        component: () => import('@/views/system/AdminAccount.vue'),
        meta: { title: '管理员账号', icon: 'Setting', needSuper: true }
      },
      {
        path: 'files',
        name: 'FileManager',
